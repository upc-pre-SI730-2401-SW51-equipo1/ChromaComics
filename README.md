<p align="center">
    ...
    <br>
    <strong>SI730 – Aplicaciones Web - SW51</strong><br>  
    <br>
    <strong>Profesor: Juan Carlos Tinoco Licas</strong><br>
    <br> <strong>INFORME DE TRABAJO FINAL - TF </strong> 
</p>
<p align="center">
    <strong>Startup: ChromaComics </strong><br>
    <strong>Producto:  Agroges</strong>
</p>
...
<div>
    <table align="center">
        ...
        <tr>
            <td>Alvaro Crispin Ccancce</td>
            <td>u202020328</td>
        </tr>
        <tr>
            <td>Fabrizzio Hernan Laguerre Challco</td>
            <td>u20211a950</td>
        </tr>
        <tr>
            <td>Andre Sebastian La torre Soto</td>
            <td>u202217772</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Miguel Ángel Huamán Cataño</td>
            <td>u202120615</td>
        </tr>
    </table>
</div>
...
|:-------:|:----------:|:-----:|:----------------------------| 
| TB1 | 10/04/2024 | Todos los integrantes del equipo | Capítulo I, Capítulo II, Capítulo III, Capítulo IV y Capítulo V |
| TP  | 29/04/2024 | Todos los integrantes del equipo | Mejoras respecto a la versión anterior <br> Sprint 2 | 
| TB2 | 06/06/2024 | Todos los integrantes del equipo | Corrección de la versión anterior <br> Versión final de la Landing Page <br> Mejora de la App Web <br> Primera versión de Web Services <br> Primera versión del Video About-The-Product <br> Primera versión del Video About-The-Team |
| TF  | 23/06/2024 | Todos los integrantes del equipo | Corrección de la versión anterior <br> Versión final de la App Web <br> Versión final de Web Services <br> Versión final del Video About-The-Product <br> Versión final del Video About-The-Team |

# Project Report Collaboration Insights

### TB1, TP, TB2 & TF:

Para la elaboración del informe correspondiente a las entregas TB1, TP, TB2 y TF, se dividió la implementación de secciones de la siguiente forma para cada miembro del equipo:

| Integrantes       | Tareas asignadas         |
| ----------------- |:------------------------:|
| **Alvaro Esteban Crispin Ccancce** | Trabajé en la creación de la página de aterrizaje (landing page) del proyecto Chromacomics. Realicé la galería de cómics con filtrado para que los usuarios puedan visualizar sus cómics según preferencia usando Vue.js y Prime Vue. Desarrollé los endpoints de cómics y filtrado para mostrar la lista de los mismos con Vue.js y Prime Vue, además de desarrollar el backend utilizando .NET 8.0. Realicé correcciones de los endpoints para que los usuarios puedan realizar sus operaciones CRUD respectivas, usando C# y Swagger para la documentación. |
| **Sergio Joel Pecan Pariona** | Trabajé en la creación de la página de aterrizaje (landing page) del proyecto Chromacomics. Desarrollé el frontend de la característica de pago, creando interfaces de usuario intuitivas y seguras para las transacciones de los usuarios. Implementé los endpoints de facturación para la compra de cómics según las preferencias de los usuarios utilizando Vue.js y Prime Vue, y desarrollé el backend utilizando .NET 8.0. Me enfoqué en la integración del frontend y el backend que había desarrollado en las fases anteriores, resultando en un sistema cohesivo y funcional. |
| **André Sebastian La Torre Soto** | Colaboré con mi equipo en la realización del informe y la creación del landing page. Desarrollé el feature de sign in y sign up del frontend, creando la interfaz necesaria para que el usuario se cree una cuenta y pueda acceder en cualquier momento. Implementé los endpoints para el feature Identity & Access Management, desarrollando sus correspondientes métodos GET y POST. Me enfoqué en la integración del frontend y el backend desarrollados en fases anteriores, probando su conexión para asegurar su funcionamiento. |
| **Miguel Ángel Huamán Cataño** | Trabajé con mi equipo en la realización del informe y colaboré en la creación del landing page. Realicé el frontend para la sección de recomendaciones de libros y corregí el informe. Implementé los endpoints para la sección de recomendaciones y las operaciones CRUD correspondientes, además de realizar correcciones en el frontend de recomendaciones. Desarrollé el endpoint de recomendaciones de libros con métodos GET, POST y DELETE, utilizando Swagger para la documentación y conectando con el frontend de recomendaciones. |
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software. | Alvaro Esteban Crispin Ccancce<br><br><br/><br>TB1<br>- Trabajó en la creación de la página de aterrizaje (landing page) del proyecto Chromacomics.<br>TP<br>- Realización de la galeria de comics con filtrado para que los usuarios puedan visualizar sus comics segun preferencia usando vue js + prime vue <br>TB2<br>Realizó los endpoints de comics y filtrado para mostrar la lista de los mismos con Vue.js y Prime Vue. Además, desarrolló el backend utilizando .NET 8.0.<br>TF<br>- Realización correciones de los end point para que los usuarios puedan realizar sus operaciones crud respectivas. Usé C#, además de swagger para la documentacion.<br><br>Sergio Joel Pecan Pariona<br><br/>TB1<br>- Trabajó en la creación de la página de aterrizaje (landing page) del proyecto Chromacomics.<br>TP<br>- Desarrolló el frontend de su característica de pago, creando interfaces de usuario intuitivas y seguras para las transacciones de los usuarios.<br>TB2<br>- Realizó los endpoints de facturación para la compra de cómics según las preferencias de los usuarios utilizando Vue.js y Prime Vue. Además, desarrolló el backend utilizando .NET 8.0.<br>TF<br>- Trabajó en la integración del frontend y el backend que había desarrollado en las fases anteriores. Esto resultó en un sistema cohesivo y funcional.<br>André Sebastian La torre Soto<br><br>TB1<br> Durante el proyecto colabore con mi equipo en la realización del informe junto a la creación del landing page <br><br>TP1<br> Para esta entrega desarrolle el feature de sign in y sign up del frontend creando la interfaz necesaria para que el usuario se creee una cuenta y pueda acceder en cualquier momento con esta misma. <br>TB2<br> Realizó los endpoints para el feature Identity & Access Managment adaptandolo para nuestor proyecto y desarrollando sus correspondientes metodos get y post para su correcta incorporacion al proyecto. <br>TF1<br> Para esta entrega me enfoque en la integración del frontend y el backend que había desarrollado en las fases anteriores. Testeando su conexion para asegurar su funcionamiento .  <br>Miguel Ángel Huamán Cataño<br><br>TB1<br>- Trabaje con mi equipo en la realización del informe y colabore en la creación del landing page<br>TP<br>- Me enfoque en realizar el frontend para la sección de recomendaciones de libros y correciones en el informe.<br>TB2<br>-En esta entrega me enfoque en realizar los endpoints para la sección de Recomendaciones, asi como las operaciones crud que se realizarán en este. Además, realice algunas correciones en la sección de recomendaciones del frontend.<br>TF<br>- Realice el endpoint de recomendaciones de libros asi como los métodos get, post y delete, ayudándome de la documentación en swagger, asi como de la conexion de esta parte con el front de la seccio´n de recomendaciones.<br> <br>Fabrizzio Hernan Laguerre Challco<br><br>TB1<br>- Trabajando en equipo para la realización del trabajo y contribuyendo en el informe, asi como investigar para poder realizar mi frontend.<br>TP<br>- Me enfoque en realizar el frontend parael carrito de compras y demás correciones en el trabajo.<br>TB2<br>- En esta entrega, me concentré en crear los endpoints para la sección del carrito de compras y las operaciones CRUD asociadas. Además, hice algunas correcciones en el diálogo del carrito de compras en el frontend.<br>TF<br>- Realice la conexión entre el frontend y el backend, y mejore mi endpoint. | Los integrantes trabajaron de manera efectiva y eficiente en el equipo multidisciplinario del proyecto Chromacomics. Su contribución fue clave tanto en el front-end como en el back-end, asegurando una integración fluida de los componentes del sistema. Además, los errores presentados durante el desarrollo se fueron resolviendo de manera efectiva.                  |
| Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software.                                                             | Alvaro Esteban Crispin Ccancce<br><br>TB1<br>- Mejoré en la creación de interfaces atractivas y efectivas para captar usuarios.<br>TP<br> Aprendí a implementar filtros dinámicos y mejorar la experiencia del usuario al navegar por la galería.<br>TB2<br>- Fortalecí mis habilidades en la integración frontend-backend y en la creación de endpoints eficientes.<br>TF<br>- Mejoré mis capacidades en la documentación de APIs con Swagger y en la optimización de operaciones CRUD.<br>TB3<br>Sergio Joel Pecan Pariona<br><br>TB1<br>- Al trabajar en la creación de la página de aterrizaje (landing page) del proyecto Chromacomics, mejoré mis habilidades en diseño y desarrollo frontend. Aprendí a crear interfaces atractivas y funcionales que capturan la atención del usuario desde el primer momento<br>TP<br>Desarrollar el frontend de la característica de pago me enseñó la importancia de la seguridad y la usabilidad en las transacciones en línea. Aprendí a implementar interfaces intuitivas que facilitan la experiencia del usuario al realizar pagos.<br>TB2<br>- A través del desarrollo y la implementación de Chromacomics, Sergio ha demostrado un conocimiento sólido del sector de las aplicaciones de software. Su trabajo en el frontend y el backend del proyecto le ha proporcionado una experiencia práctica valiosa en el desarrollo de aplicaciones web.<br>TF<br>- La integración del frontend y el backend fue una experiencia valiosa para entender cómo ambos componentes deben trabajar juntos de manera cohesiva. Aprendí a resolver problemas de compatibilidad y a optimizar el rendimiento del sistema, asegurando que todas las funcionalidades se ejecuten sin problemas<br> <br>André Sebastian La torre Soto<br> <br>TB1<br> Colaborando con mi equipo en la realizacion del trabajo al contribuir con la seccion del capitulo 1, pude reconocer un programa que pueda cumplir con lo que nuestros segmentos objetivos estaban buscando.  <br>TP1<br>  Para esta entrega me enfoque en realizar el frontend para la parte de registro e inicio de sesion para los usuarios, fortaleciendo mis conocimientos de frontend vistos durante clases y mi comprension respecto al trabajo que se desarrolla en el front-end. <br>TB2<br> Al implementar los endpoints y las operaciones necesarias para la sección de sign in y sign up en el backend, así como las correcciones en el frontend, he conseguido un mayor entendimiento en la práctica de desarrollo de una aplicación web. <br>TF1<br> Para esta entrega conecte el front-end con el back-end, aprendiendo a integrarlos correctamente y a desplegar nuestra aplicación, lo cual me proporcionó experiencia práctica valiosa para mi futuro como programador.<br><br>Miguel Ángel Huamán Cataño<br><br>TB1<br>- Trabajando en equipo para la realización del trabajo y contribuyendo al realizar las historias de usuario, adquirí más conocimiento sobre las funcionalidades necesarias para que el usuario pueda tener una buena experiencia con nuestra app<br>TP<br>- A l enfocarme en realizar el frontend para la sección de recomendaciones de libros mejore mis conocimientos de frontend vistos en clases y comprendi más el labor de un programador frontend.<br>TB2<br>- Implementando los endpoints y operaciones crud para la sección de Recomendaciones en el back-end, así como las correcciones en el frontend, he adquirido experiencia práctica en el desarrollo de una aplicación web. Además he podido colaborar con mi equipo en las mejoras realizadas para el proyecto.<br>TF<br>- Realizando la conexión entre el frontend y el backend aprendí a como conectarlos para finalmente realizar el deploy de nuestra aplicación, añadiendo así experiencia práctica para mi futuro rol como programador.<br> <br>Fabrizzio Hernan Laguerre Challco<br><br>TB1<br>- Trabajando en equipo e investigando mejore los conocimientos que tenía sobre el frontend<br>TP<br>- A l enfocarme en realizar el frontend aumente mis conocimientos y profundice en lo visto en clases. <br>TB2<br>- Al implementar los endpoints y las operaciones CRUD para la sección de ShoppingCart en el backend, así como las correcciones en el frontend, he ganado experiencia práctica en el desarrollo de una aplicación web. Además, he tenido la oportunidad de colaborar con mi equipo en las mejoras del proyecto.<br>TF<br>-Profundice mis conocimientos y adquirí experiencia práctica.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Los integrantes demostraron un buen conocimiento del sector de aplicaciones de software a través del proyecto Chromacomics. Desarrolló componentes clave como la tabla de cómics con filtrado en el front-end y los endpoints CRUD en el back-end. Esto se vio reflejado en el primer uso de la aplicación por parte de los usuarios y su satisfacción con nuestra solución. |
...
<img src="https://github.com/upc-pre-SI730-2401-SW51-equipo1/ChromaComics/assets/129322252/84e6a254-c8eb-43a3-85fc-19a565bdb1f1" width="700"/>
...
![Alt text](https://github.com/upc-pre-SI730-2401-SW51-equipo1/ChromaComics/blob/Informe/assets/analisiscompetitivo1.png)
![Alt text](https://github.com/upc-pre-SI730-2401-SW51-equipo1/ChromaComics/blob/Informe/assets/analisiscompetitivo2.png)
![Alt text](https://github.com/upc-pre-SI730-2401-SW51-equipo1/ChromaComics/blob/Informe/assets/analisiscompetitivo3.png)
![Alt text](https://github.com/upc-pre-SI730-2401-SW51-equipo1/ChromaComics/blob/Informe/assets/analisiscompetitivo4.png)
![Alt text](https://github.com/upc-pre-SI730-2401-SW51-equipo1/ChromaComics/blob/Informe/assets/analisiscompetitivo5.png)
![Alt text](https://github.com/upc-pre-SI730-2401-SW51-equipo1/ChromaComics/blob/Informe/assets/analisiscompetitivo6.png)
![Alt text](https://github.com/upc-pre-SI730-2401-SW51-equipo1/ChromaComics/blob/Informe/assets/analisiscompetitivo7.png)
